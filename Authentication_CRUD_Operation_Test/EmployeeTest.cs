...
namespace Authentication_CRUD_Operation_Test
{
    public class EmployeeTest
    {
        ...
        public EmployeeTest()
        {
            ...
            _employeeController = new EmployeeController(_employeeRepository, _mapperMock.Object);
        }
        ...
        private void SeedDatabase(ApplicationDbContext context)
        {
            ...
            {
                new Employee { Id = Guid.NewGuid(), Name = "John", Email = "john@example.com", Salary = 50000 },
                new Employee { Id = Guid.NewGuid(), Name = "Jane", Email = "jane@example.com", Salary = 60000 }
            };
        ...
        public async Task GetAllEmployees_ReturnsSuccessStatusCode()
        {
            ...
            {
                new EmployeeDto { Name = "John", Email = "john@example.com", Salary = 50000 }
            };
